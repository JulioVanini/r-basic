...
acos(-8)
sqrt(2)
print(sqrt(2),10) #indica cuantas cifras va a mostrar 
round(sqrt(2), 3) #redondear despues de las cifras indicadas
floor(sqrt(2))
ceiling(sqrt(2))
trunc(sqrt(2))
...
print(2^50, 2)
print(pi, 13)
#3.141592653589793115998 #Despues de 16 dijisto R tiende a ser impreciso
